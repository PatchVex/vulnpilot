...
def generate_html_report(
    ...
    """Generate a self-contained HTML report for all findings.
...
<div class="section">
  <div class="section-title">Prioritized Findings — {total:,} vulnerabilities</div>
